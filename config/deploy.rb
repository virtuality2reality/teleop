## Generated with 'brightbox' on 2011-07-13 18:20:28 +0200
gem 'brightbox', '>=2.3.8'
...
set :application, "teleop_production"

# Primary domain name of your application. Used in the Apache configs
set :domain, "teleop.world-valley.com"

## List of servers
server "worldvalley-001.vm.brightbox.net", :app, :web, :db, :primary => true
...
set :scm, :git
set :repository, "git@github.com:virtuality2reality/teleop.git"
set :branch, :master
